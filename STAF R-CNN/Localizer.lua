...
function Localizer:__init(outnode)
  ...
  local function trace_modules(node)  -- deep-copy modules
    local modules = {}
  ...
  local function create_layer_info(modules) 
    local info = {}
    for i,m in ipairs(modules) do -- retrieve information of all spatial convolution layers across modules
  ...
  -- 'layers' store all the information of conv layers
